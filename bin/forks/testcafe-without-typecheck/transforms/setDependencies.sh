...
sed -i "s|\x22testcafe-reporter-spec\x22: \x22[^\x22]*\x22,|\x22testcafe-reporter-for-e2ed\x22: \x220.0.2\x22,|" ./bin/forks/testcafe-without-typecheck/package/package.json
