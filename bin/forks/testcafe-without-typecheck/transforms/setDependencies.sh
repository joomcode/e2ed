...
sed -i "s/\x22testcafe-hammerhead\x22: \x22[^\x22]*\x22,/\x22testcafe-hammerhead-up\x22: \x2230.1.0-rc.1\x22,/" ./bin/forks/testcafe-without-typecheck/package/package.json
