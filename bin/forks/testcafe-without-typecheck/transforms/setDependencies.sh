...
sed -i "s/\x22testcafe-hammerhead\x22: \x22[^\x22]*\x22,/\x22testcafe-hammerhead-up\x22: \x2229.0.0-rc.1\x22,/" ./bin/forks/testcafe-without-typecheck/package/package.json
sed -i "s|\x22testcafe-reporter-spec\x22: \x22[^\x22]*\x22,|\x22testcafe-reporter-for-e2ed\x22: \x220.0.3\x22,|" ./bin/forks/testcafe-without-typecheck/package/package.json
