...
import {e2edClickOnStep as clientE2edClickOnStep} from './e2edClickOnStep';
...
const e2edClickOnStep = clientE2edClickOnStep;
...
export const initialScript = (): void => {
  ...
  e2edAddOnClickOnClass('step-expanded', e2edClickOnStep);
